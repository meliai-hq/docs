...
description: "Meliai bills by energy consumption (kWh) or credits depending on the model. Every response includes a billing_cost field showing exactly what was charged."
---
...
<CardGroup cols={2}>
  <Card title="Energy billing" icon="bolt">
  ...
  <Card title="Credit billing" icon="coins">
