---
title: "Authenticate Your Requests to the Meliai API"
sidebarTitle: "Authentication"
description: "Meliai uses API keys prefixed with sk-mel-. Pass your key as a Bearer token or x-api-key header on every request."
---
