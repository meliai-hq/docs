...
description: "Send chat requests with tools, streaming, and structured output via POST /v1/chat/completions. OpenAI-compatible, EU-routed, with impact and cost fields."
---
