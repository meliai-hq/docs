...
description: "POST /v1/embeddings — generate vector embeddings from text for semantic search, RAG, and similarity tasks. OpenAI-compatible with European infrastructure."
---
