---
title: "Meliai API Reference — Endpoints and Schemas"
sidebarTitle: "Overview"
description: "Complete reference for the Meliai API. Two compatible shapes — OpenAI and Anthropic — one base URL, one API key, and Meliai-specific routing and impact fields."
---
