---
title: "Meliai API Error Codes and Troubleshooting"
sidebarTitle: "Errors"
description: "All Meliai API errors use a consistent JSON shape with a stable error code. Match on code for programmatic handling and use message for human-readable context."
---
