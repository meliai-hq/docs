---
title: "Stream Chat Responses in Real Time with Meliai API"
sidebarTitle: "Streaming"
description: "Enable Meliai streaming to receive chat completion tokens as they are generated via server-sent events, fully compatible with the OpenAI SDK interface."
---
