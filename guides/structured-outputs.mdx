---
title: "Get Structured JSON Output from Meliai Models"
sidebarTitle: "Structured Outputs"
description: "Use response_format to enforce valid JSON or a strict JSON schema in Meliai chat completions, ideal for data extraction, classification, and automated pipelines."
---
