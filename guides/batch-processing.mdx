...
description: "Use the Meliai Batch API to run thousands of inference requests asynchronously at reduced cost. Upload a JSONL file, submit the batch, and poll for results."
---
